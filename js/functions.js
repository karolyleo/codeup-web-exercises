...
let isTwoOutput = isTwo(random);
console.log(isTwoOutput);
/**
 * TODO:
...
let tipPercentage = prompt("What percentage tip would you like to leave? (Please type 15% as '.15')");
let tipUser = calculateTip(tipPercentage, totalBill);
alert(tipUser);
/**
 * TODO:
...
function applyDiscount(initialPrice, discountPercent){
    let difference = initialPrice * discountPercent;
    let discount = initialPrice - difference;
